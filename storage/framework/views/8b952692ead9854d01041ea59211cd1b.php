...
form.addEventListener("submit", async function (e) {
    ...
    loadingMsg.innerHTML = `
        <div class="bg-light text-secondary p-2 rounded-3 border">
            <b>IA:</b> Pensando...
        </div>`;
    ...
    try {
        let response = await fetch("<?php echo e(route('chat.send')); ?>", {
            method: "POST",
            headers: {
        ...
        errorMsg.innerHTML = `
            <div class="bg-danger text-white p-2 rounded-3" 
                 style="max-width: 75%;">
                 <b>Erro:</b> Não foi possível gerar uma resposta.
            </div>`;
...
<?php /**PATH C:\Users\aluno\Desktop\IA\ChatBotSETEC\resources\views/chat/index.blade.php ENDPATH**/ ?>